                            ...
                            <div class="col-md-12 mb-1-6 mb-md-1-9 mb-lg-2-5">
                                <div class="card card-style1 p-0 h-100">
                                    <div class="card-img rounded-0 border-color-secondary">
                                        ...
                                        <a href="#!" class="course-tag secondary">Design</a>
                                        <a href="#!"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="card-body position-relative pt-0 px-1-9 pb-1-9">
                                        <div class="card-author d-flex">
                            ...
                            <div class="col-md-12 mb-1-6 mb-md-1-9 mb-lg-2-5">
                                <div class="card card-style1 p-0 h-100">
                                    <div class="card-img rounded-0">
                                        ...
                                        <a href="#!" class="course-tag">Network</a>
                                        <a href="#!"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="card-body position-relative pt-0 px-1-9 pb-1-9">
                                        <div class="card-author d-flex">
                            ...
                            <div class="col-md-12 mb-1-6 mb-md-1-9 mb-lg-2-5">
                                <div class="card card-style1 p-0 h-100">
                                    <div class="card-img rounded-0 border-color-secondary">
                                        ...
                                        <a href="#!" class="course-tag secondary">Photography</a>
                                        <a href="#!"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="card-body position-relative pt-0 px-1-9 pb-1-9">
                                        <div class="card-author d-flex">
                            ...
                            <div class="col-md-12 mb-1-6 mb-md-1-9 mb-lg-2-5">
                                <div class="card card-style1 p-0 h-100">
                                    <div class="card-img rounded-0">
                                        ...
                                        <a href="#!" class="course-tag">Music</a>
                                        <a href="#!"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="card-body position-relative pt-0 px-1-9 pb-1-9">
                                        <div class="card-author d-flex">
                            ...
                            <div class="col-md-12">
                                <div class="card card-style1 p-0 h-100">
                                    <div class="card-img rounded-0 border-color-secondary">
                                        ...
                                        <a href="#!" class="course-tag secondary">Finance</a>
                                        <a href="#!"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="card-body position-relative pt-0 px-1-9 pb-1-9">
                                        <div class="card-author d-flex">
