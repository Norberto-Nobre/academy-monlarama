...
try {
    ...
    $mail->Body = "
        ...
        <head>
            ...
            <style>
                ...
                .info-item { margin: 10px 0; padding: 10px; background-color: #f9f9f9; border-left: 4px solid #007cba; }
    ...
    if ($mail->send()) {
        ...
        error_log("Inscrição enviada com sucesso - Email: $email, Curso: $curso");
    ...
    // Log do erro
    error_log("Erro ao enviar email de inscrição: " . $mail->ErrorInfo);
    
    // Redirecionar com erro
    header('Location: contact.php?error=' . urlencode('Erro interno. Tente novamente mais tarde.'));
    exit();
}
?>