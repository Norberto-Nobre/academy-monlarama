                            ...
                            <div class="col-md-12">
                                <div class="row">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="topics">Latest version of WordPress and it's Benefit</td>
                                    ...
                                    <div class="col-md-12 event-seprator">
                                        ...
                                        <p class="alt-font font-weight-500 text-color mb-1-6">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                                        <ul class="event-meta mb-4 ps-0">
                                            <li><i class="ti-location-pin"></i>Newyork City, USA</li>
                                            <li><i class="ti-mobile"></i>+012 (345) 6789</li>
                                        </ul>
                                        <iframe width="100%" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=london&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
