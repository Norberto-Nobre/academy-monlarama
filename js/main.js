...
! function (t) {
   ...
   t("#preloader").fadeOut("normall", function () {
      ...
      e <= 50 ? (t("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "img/logos/logo-mon.png")) : (t("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "img/logos/logo-mon.png")), o.attr("src", "img/logos/logo-mon.png")
   }), s.on("scroll", function () {
      ...
      t(".testimonial-carousel").owlCarousel({
         ...
         e = e.item.index - 2;
         t(".h5").removeClass("animated fadeInUp"), t(".title").removeClass("animated fadeInUp"), t("p").removeClass("animated fadeInUp"), t("a").removeClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find(".h5").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find(".title").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("p").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("a").addClass("animated fadeInUp")
